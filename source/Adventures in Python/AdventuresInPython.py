...
#setting times to a and b for my time.sleep() function
a = 2 # seconds
b = 0.2 # seconds
...
def game():
    ...
    if firstChoice != '1' and firstChoice != '2' and firstChoice != '3':
        print()
        print("That seems to be an invalid Entry. "
              "Please enter '1', '2', or '3' followed by ENTER: ")
...
def intro():
    ...
    startGame = str(input("Please select 'Y' or 'N' followed by ENTER! "))
    ...
    elif startGame != 'n' and startGame != 'N' and startGame != 'y' and startGame != 'Y':
        print()
        print("That does not seem to be a valid entry. Please select 'Y' or 'N' followed by ENTER! ")
        print()
        intro()
intro()
